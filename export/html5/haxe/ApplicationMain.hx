...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("dfvoice", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("dfvoice", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "dfvoice";
		app.meta["name"] = "dfvoice";
